// @trading-platform/sdk/intake — intake facade surface (feature 036, Phase 9 / T055).
//
...
// (`@trading-platform/sdk/intake/http-transport`) is a SEPARATE subpath and is intentionally NOT
